      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Remote Shutter Section
            _buildSectionCard(
              context,
              theme,
              isDark,
              'Remote Shutter',
              'Configure camera remote control settings',
            ...
            _buildSectionCard(
              ...
              isDark,
              'OTA Upgrade',
              'Check for software updates and manage firmware',
              Icons.system_update,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Advanced device controls, enhanced camera features, and priority firmware updates.',
              style: theme.textTheme.bodyMedium?.copyWith(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              'Unlock advanced device controls, enhanced camera features, and priority firmware updates.',
              style: theme.textTheme.bodyMedium?.copyWith(
                color: isDark ? Colors.white70 : const Color(0xFF64748B),
              ),
            ),
