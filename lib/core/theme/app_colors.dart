...
class AppColors {
  ...
  static const Color googleBlue = Color.fromARGB(255, 199, 199, 199);
  static const Color googleRed = Color(0xFFEA4335);
  static const Color googleYellow = Color(0xFFFBBC05);
  static const Color googleGreen = Color(0xFF34A853);
  static const Color googleBackground = Color(0xFFFFFFFF);
  static const Color facebookBlue = Color.fromARGB(255, 199, 199, 199);
  static const Color facebookBackground = Color(0xFFFFFFFF);
  static const Color facebookText = Color(0xFF212121);
  static const Color googleText = Color(0xFF212121);

  // For dark theme overlays
  static const Color overlayDark = Color(0xCC222222);
